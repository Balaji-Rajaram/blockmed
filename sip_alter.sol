...
contract blockmed{
    ...
    function manfucture_entry(string med_id,string medicin_name,string licence_num,string m_name,string m_address,string m_date,string e_date)public{
        ...
        f_medicin_name.push(medicin_name);
        f_med_id.push(med_id);
    }
    ...
    function distributor_entry(string med_id,string licence_num,string d_name,string d_address,string recived_time,string transport_by)public{
        d_data[med_id].name.push(d_name);
        d_data[med_id].licence_num.push(licence_num);
        d_data[med_id].distributor_address.push(d_address);
        d_data[med_id].recived_time.push(recived_time);
        d_data[med_id].transport_by.push(transport_by);
        d_data[med_id].Type.push("Distributor");
    }
    function local_distributor_entry(string med_id,string licence_num,string l_name,string l_address,string recived_time,string transport_by)public{
        l_data[med_id].name.push(l_name);
        l_data[med_id].licence_num.push(licence_num);
        l_data[med_id].local_distributor_address.push(l_address);
        l_data[med_id].recived_time.push(recived_time);
        l_data[med_id].transport_by.push(transport_by);
        l_data[med_id].Type.push("Local Distributor");
    }
    ...
    function medicin_id_finder()public view returns(string[],string[]){
        return(f_medicin_name,f_med_id);
    }
    
    function find_local_distributor(string med_id)public view returns(string[],string[]){
        return(l_data[med_id].local_distributor_address,l_data[med_id].name);
    }
