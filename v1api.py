...
address='0x114171325C7c3a0e121B8B83Ac8Ee27Cbd798A8d'
abi=json.loads('[{"constant":true,"inputs":[{"name":"med_id","type":"string"}],"name":"med_votes","outputs":[{"name":"","type":"uint256"},{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"med_id","type":"string"}],"name":"manf_data","outputs":[{"name":"","type":"string"},{"name":"","type":"string"},{"name":"","type":"string"},{"name":"","type":"string"},{"name":"","type":"string"},{"name":"","type":"string"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"medicin_id_finder","outputs":[{"name":"","type":"string[]"},{"name":"","type":"string[]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"med_id","type":"string"}],"name":"like_med","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"med_id","type":"string"},{"name":"licence_num","type":"string"},{"name":"d_name","type":"string"},{"name":"d_address","type":"string"},{"name":"recived_time","type":"string"},{"name":"transport_by","type":"string"}],"name":"distributor_entry","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"med_id","type":"string"},{"name":"medicin_name","type":"string"},{"name":"licence_num","type":"string"},{"name":"m_name","type":"string"},{"name":"m_address","type":"string"},{"name":"m_date","type":"string"},{"name":"e_date","type":"string"}],"name":"manfucture_entry","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"med_id","type":"string"}],"name":"local_dis_data","outputs":[{"name":"","type":"string[]"},{"name":"","type":"string[]"},{"name":"","type":"string[]"},{"name":"","type":"string[]"},{"name":"","type":"string[]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"med_id","type":"string"}],"name":"dislike_med","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"med_id","type":"string"}],"name":"find_local_distributor","outputs":[{"name":"","type":"string[]"},{"name":"","type":"string[]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"med_id","type":"string"},{"name":"licence_num","type":"string"},{"name":"l_name","type":"string"},{"name":"l_address","type":"string"},{"name":"recived_time","type":"string"},{"name":"transport_by","type":"string"}],"name":"local_distributor_entry","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"med_id","type":"string"}],"name":"dis_data","outputs":[{"name":"","type":"string[]"},{"name":"","type":"string[]"},{"name":"","type":"string[]"},{"name":"","type":"string[]"},{"name":"","type":"string[]"}],"payable":false,"stateMutability":"view","type":"function"}]')
...
@app.route('/findLocalAddress', methods=["GET","POST"])
def findLocalAddress():
    if(request.method=='POST'):
        try:
            data=[]
            req=request.json
            medicin_name=req['medicin_name']
            s_data=contract.functions.medicin_id_finder().call()
            for i in range (0,len(s_data[0])):
                if(medicin_name==s_data[0][i]):
                    l=contract.functions.find_local_distributor(s_data[1][i]).call()
                    print(l)
                    if(len(l)):
            ...
            if(len(data)):
                ...
                res={'message':'medicin name is not exixst'}            
